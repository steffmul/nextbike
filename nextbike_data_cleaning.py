...
all_trips.columns = [
    'index', 'trip_id', 'bike_id', 'trip_duration',
    'trip_start_time', 'trip_end_time', 'from_station', 'from_station_id',
    'from_station_mode', 'from_lat', 'from_long', 'to_station',
    'to_station_id', 'to_station_mode', 'to_lat', 'to_long']
...
all_trips = all_trips[
    all_trips['trip_duration'].between(1, 1440, inclusive=True)
    ]
